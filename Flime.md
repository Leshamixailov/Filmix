...
Приложение будет использовать стандартные библиотеки Java 1.8
...
1.	Приложение должно загружаться в течении 5 секунд
2.  приложение не трубует предворительной настройки.
# 3.2.2 Ограничения
